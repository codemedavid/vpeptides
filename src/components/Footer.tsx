...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white/50 backdrop-blur-md pt-16 pb-8 border-t border-pastel-blue-100 relative z-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div className="flex flex-col items-center md:items-start gap-3">
            <h3 className="text-pastel-blue-900 font-bold text-sm uppercase tracking-wider mb-2">Contact Us</h3>

            <a
              href="mailto:Glowwithjoo2026@gmail.com"
              className="text-charcoal-600 hover:text-blush-500 transition-colors flex items-center gap-2 text-sm"
            >
            ...
            <div className="text-charcoal-600 flex items-center gap-2 text-sm mt-2 border-t border-pastel-blue-100/50 pt-3">
          ...
          {/* Quick Links */}
          <div className="flex flex-col items-center md:items-start gap-3">
            <h3 className="text-pastel-blue-900 font-bold text-sm uppercase tracking-wider mb-2">Quick Links</h3>
            <a
              href="#"
              className="text-charcoal-600 hover:text-blush-500 transition-colors flex items-center gap-2 text-sm"
            >
              <FlaskConical className="w-4 h-4 text-pastel-blue-400" />
              Products
            </a>
            <a
              href="/track-order"
              className="text-charcoal-600 hover:text-blush-500 transition-colors flex items-center gap-2 text-sm"
            >
              <Truck className="w-4 h-4 text-pastel-blue-400" />
              Track Order
            </a>
            <a
              href="/faq"
              className="text-charcoal-600 hover:text-blush-500 transition-colors flex items-center gap-2 text-sm"
            >
              <HelpCircle className="w-4 h-4 text-pastel-blue-400" />
              FAQ
            </a>
          </div>
        ...
        {/* Divider */}
        <div className="h-px bg-pastel-blue-100 mb-6" />
